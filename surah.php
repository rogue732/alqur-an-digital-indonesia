  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 text-center justify-content-center">
            ...
            <?php 
            $id = $_GET['number'];
            $link = file_get_contents("https://api.quran.sutanlab.id/surah/$id");
            $data = json_decode($link, true);
            ?>

            <?php foreach ($data['data']['verses'] as $key) : ?>

            <div class="container">
            <div class="col-12 text-white">
                                <div class="row">
                                    <div class="col-md-6">
                                        <br><p><b><?= $key['text']['arab']; ?></b></p>
                                        <p><?= $key['text']['transliteration']['en']; ?></p>
                                        <b>Artinya:</b> <i>"<?= $key['translation']['id']; ?>"</i>
                                    </div>
                                    <div class="col-md-6">
                                        <br><audio controls="" class="pb-3">
                                        <source src="<?= $key['audio']['primary']; ?>" type=""></audio><br>
                                        <i>Ayat <?= $key['number']['inSurah']; ?></i>
                                    </div>
                                </div>
