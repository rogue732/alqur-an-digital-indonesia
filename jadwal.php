  ...
  <body id="home" style="background: linear-gradient(to bottom, #000428, #004e92);">
    ...
    <div class="container mb-3">
        ...
        <div class="row mt-4 mb-4 justify-content-center">
            <?php 
            $id = $_GET['kota'];
            $link = file_get_contents("https://api.pray.zone/v2/times/today.json?city=$id");
            $data = json_decode($link, true);
            ?>

            <?php foreach ($data['results']['datetime'] as $key) : ?>
            ...
            <div class="col-sm-4">
                <div class="thumbnail text-white">         
                    <div class="card animate__animated animate__lightSpeedInLeft" style="border-radius: 20px; background-image: url('onta.jpg');">
                        <div class="card-body">
                                <p>HARI INI: <?= $key['date']['gregorian']; ?></p>
                                <br>
                                <b><p>Imsak: <?= $key['times']['Imsak']; ?></p></b>
                        </div>
                    </div>
                </div><br>
            </div> 
                ...
                <div class="thumbnail text-white">         
                    <div class="card animate__animated animate__lightSpeedInLeft" style="border-radius: 20px; background-image: url('onta.jpg');">
                        <div class="card-body">
                                <p>HARI INI: <?= $key['date']['gregorian']; ?></p>
                                <br>
                                <b><p>Dzuhur: <?= $key['times']['Dhuhr']; ?></p></b>
                        </div>
                    </div>
                </div><br>
            </div>
                ...
                <div class="thumbnail text-white">         
                    <div class="card animate__animated animate__lightSpeedInLeft" style="border-radius: 20px; background-image: url('onta.jpg');">
                        <div class="card-body">
                                <p>HARI INI: <?= $key['date']['gregorian']; ?></p>
                                <br>
                                <b><p>Maghrib: <?= $key['times']['Maghrib']; ?></p></b>
                        </div>
                    </div>
                </div><br>
            </div> 
