...
$link = file_get_contents('https://api.npoint.io/99c279bb173a6e28359c/data');
            ...
            <div class="col-sm-4">
               <div class="thumbnail text-white">
                    <div class="card animate__animated animate__rotateInDownLeft" style="height: 200px; border-radius: 20px; background-image: url('onta.jpg');">
                        <div class="card-body">
                            <b><?= $row['nomor']; ?>. <a href="
                            surah.php?number=<?= $row['nomor']; ?>" style="color: #FFFFFF;"><?= $row['nama']; ?></a></b><br><br>
                            <div class="row">
                                <div class="col-sm-6"><b><?= $row['arti']; ?></b></div>
                                <div class="col-sm-6"><b><?= $row['asma']; ?></b></div>
                            </div><br>
                            <audio controls="" class="pb-3">
                                <source src="<?= $row['audio']; ?>" type=""></audio>
                        </div>
                   </div>
                   <br><br>
               </div>
